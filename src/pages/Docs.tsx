...
import { BookOpen, Shield, Code, Users, Globe, Lock, CheckCircle, AlertTriangle, Info } from "lucide-react";
const Docs = () => {
        ...
        <div className="space-y-8">
          ...
          <Card>
            ...
            <CardContent className="prose max-w-none">
              <p className="text-gray-700 mb-4">Bucket Sheild makes it easy to create secure S3 bucket policies without writing JSON manually. Follow these steps to get started:</p>
